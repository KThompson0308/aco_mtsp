...
{
    "distutils": {
        "name": "aco_mtsp.Solver",
        "sources": [
            "aco_mtsp/Solver.pyx"
        ]
    },
    "module_name": "aco_mtsp.Solver"
}
END: Cython Metadata */
...
#define __PYX_HAVE__aco_mtsp__Solver
#define __PYX_HAVE_API__aco_mtsp__Solver
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "aco_mtsp.Solver" */
#if !CYTHON_COMPILING_IN_LIMITED_API
#endif
#define __Pyx_MODULE_NAME "aco_mtsp.Solver"
extern int __pyx_module_is_main_aco_mtsp__Solver;
int __pyx_module_is_main_aco_mtsp__Solver = 0;

/* Implementation of "aco_mtsp.Solver" */
static const char __pyx_k_main[] = "__main__";
static const char __pyx_k_name[] = "__name__";
static const char __pyx_k_test[] = "__test__";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_Solve_Specified_Networks_for_Opt[] = "Solve Specified Networks for Optimal Solution";
#if !CYTHON_COMPILING_IN_LIMITED_API
...
namespace {
  struct PyModuleDef __pyx_moduledef = {
    ...
    static struct PyModuleDef __pyx_moduledef = {
        ...
        "Solver",
        __pyx_k_Solve_Specified_Networks_for_Opt, /* m_doc */
      #if CYTHON_PEP489_MULTI_PHASE_INIT
        0, /* m_size */
      #elif CYTHON_COMPILING_IN_LIMITED_API
...
bad:
  ...
  #endif
  {
    ...
    #else
    #if PY_MAJOR_VERSION < 3
    __pyx_m = Py_InitModule4("Solver", __pyx_methods, __pyx_k_Solve_Specified_Networks_for_Opt, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
...
if (!__Pyx_RefNanny) {
  ...
  if (!__Pyx_RefNanny)
    ...
    #endif
    if (__pyx_module_is_main_aco_mtsp__Solver) {
      if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
    }
    #if PY_MAJOR_VERSION >= 3
    {
      PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
      if (!PyDict_GetItemString(modules, "aco_mtsp.Solver")) {
        if (unlikely(PyDict_SetItemString(modules, "aco_mtsp.Solver", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
      }
    }
    #endif
    /*--- Builtin init code ---*/
 ...
 */
    ...
    if (__pyx_m) {
      ...
      if (__pyx_d) {
        #endif
        __Pyx_AddTraceback("init aco_mtsp.Solver", __pyx_clineno, __pyx_lineno, __pyx_filename);
        #if !CYTHON_COMPILING_IN_LIMITED_API
      }
      Py_CLEAR(__pyx_m);
      #endif
    } else if (!PyErr_Occurred()) {
      PyErr_SetString(PyExc_ImportError, "init aco_mtsp.Solver");
    }
    __pyx_L0:;
    __Pyx_RefNannyFinishContext();
    #if CYTHON_PEP489_MULTI_PHASE_INIT
